...
/deis/router/healthEndpoint                  nginx health check endpoint (default: "/health-check")
...
/deis/router/redirectAllHTTPToHTTPS/enabled  cluster-wide SSL redirect of http traffic to https
